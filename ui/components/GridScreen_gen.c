...
lv_obj_t * GridScreen_create(lv_obj_t * parent)
{
    ...
    if (!style_inited) {
        ...
        static const int32_t style_grid_grid_column_dsc_array_6[] = {LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
        lv_style_set_grid_column_dsc_array(&style_grid, style_grid_grid_column_dsc_array_6);
        static const int32_t style_grid_grid_row_dsc_array_7[] = {LV_GRID_FR(1), LV_GRID_FR(2), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
        lv_style_set_grid_row_dsc_array(&style_grid, style_grid_grid_row_dsc_array_7);
    ...
    lv_obj_t * Tile_2 = Tile_create(lv_obj_2, "1:36:43", "BEST LAP", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_set_style_grid_cell_column_pos(lv_obj_3, 0, 0);
    lv_obj_set_style_grid_cell_row_pos(lv_obj_3, 2, 0);
    ...
    static const int32_t lv_obj_4_style_grid_column_dsc_array_2[] = {LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    lv_obj_set_style_grid_column_dsc_array(lv_obj_4, lv_obj_4_style_grid_column_dsc_array_2, 0);
    static const int32_t lv_obj_4_style_grid_row_dsc_array_3[] = {LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    ...
    lv_obj_t * Tile_4 = Tile_create(lv_obj_4, "77", "SPEED", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_5 = Tile_create(lv_obj_4, "48.1", "FUEL", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_6 = Tile_create(lv_obj_6, "1", "POS", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_7 = Tile_create(lv_obj_6, "56", "LAP", lv_font_montserrat_20, lv_font_montserrat_8);
