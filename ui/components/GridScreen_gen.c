...
lv_obj_t * GridScreen_create(lv_obj_t * parent)
{
    ...
    lv_image_set_src(lv_image_0, MonsterVRedbullScaled);
    ...
    lv_obj_t * Tile_2 = Tile_create(lv_obj_5, "1:36:43", "BEST LAP", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_3 = Tile_create(lv_obj_5, "9888", "RPM", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_4 = Tile_create(lv_obj_7, "77", "SPEED", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_5 = Tile_create(lv_obj_7, "48.1", "FUEL", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_set_style_bg_color(lv_obj_9, lv_color_hex3(0x000), 0);
    lv_obj_set_style_border_color(lv_obj_9, lv_color_hex3(0x000), 0);
    lv_obj_t * Tile_6 = Tile_create(lv_obj_9, "1", "POS", lv_font_montserrat_20, lv_font_montserrat_8);
    ...
    lv_obj_t * Tile_7 = Tile_create(lv_obj_9, "56", "LAP", lv_font_montserrat_20, lv_font_montserrat_8);
