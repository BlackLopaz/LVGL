/**
 * @file ConfigureableButton_gen.c
...
#include "ConfigureableButton_gen.h"
#include "../ui.h"
...
lv_obj_t * ConfigureableButton_create(lv_obj_t * parent, int32_t x, int32_t y, const char * text)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_radius(&style_base, x);
        lv_style_set_pad_hor(&style_base, x);
        lv_style_set_pad_ver(&style_base, y);
    ...
    lv_obj_set_name_static(lv_button_0, "ConfigureableButton_#");
