...
lv_obj_t * StartScreen_create(void)
{
    ...
    lv_obj_set_style_align(lv_obj_1, LV_ALIGN_CENTER, 0);
    lv_obj_set_width(lv_obj_1, lv_pct(28));
    lv_obj_set_height(lv_obj_1, lv_pct(50));
    lv_obj_set_style_radius(lv_obj_1, lv_pct(100), 0);
    lv_obj_set_style_border_color(lv_obj_1, lv_color_hex(0xEAECEC), 0);
    lv_obj_set_style_bg_color(lv_obj_1, lv_color_hex(0xEAECEC), 0);
    ...
    lv_obj_set_style_border_color(lv_button_0, lv_color_hex(0x490000), 0);
    ...
    lv_obj_set_style_pad_row(lv_button_0, lv_pct(10), 0);
    lv_obj_set_style_pad_left(lv_button_0, 55, 0);
